...
@section('content')
    ...
    <form action="{{ route('sales.store') }}" method="POST">
        ...
        <x-adminlte-input name="date" label="Fecha de Venta" type="date" value="{{ old('date', date('Y-m-d')) }}" required />
        ...
        <div id="productos-container">
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <x-adminlte-input name="quantities[]" label="Cantidad" type="number" min="1" required />
                </div>
        ...
        <x-adminlte-button label="Guardar Venta" type="submit" theme="success" class="btn-block" />
    </form>
@stop
